...
The data is very skewed. The dot plots below show the variance in the data. The number of deaths per earthquake has a high level of randomness.
```{r}
...
Based on our assumptions we know that our p-value is correct to use. Since our p-value = 0.5544  0.05, so we fail to reject the null hypothesis, which means: There is statistically significant evidence that the average number of earthquake deaths does not differ by region
